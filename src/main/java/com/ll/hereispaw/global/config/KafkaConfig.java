...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, PostEventDto> consumerPostFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PostEventDto> kafkaListenerContainerPostFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PostEventDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerPostFactory());
        return factory;
    }

    @Bean
    public ConsumerFactory<String, MemberEventDto> consumerMemberFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaServer);
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MemberEventDto> kafkaListenerContainerMemberFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MemberEventDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerMemberFactory());
        return factory;
    }
}
